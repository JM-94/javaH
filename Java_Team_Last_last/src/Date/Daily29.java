...
public class Daily29 extends JFrame{
	private String year;
	private String month;
	private String input_month;
	public Daily29(String year, String month, String input_month) {
		this.year=year;
		this.month=month;
