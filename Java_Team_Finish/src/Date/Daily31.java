...
public class Daily31 extends JFrame{
	Select sel;
	private String year;
	private String month;
	public Daily31(String year, String month) {
		this.year=year;
		this.month=month;
		...
		JButton btnNewButton_31 = new JButton("31");
		btnNewButton_31.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Month.str =year+month+"31";
				new Sales(Month.str);
			}
		});
		btnNewButton_31.setBounds(152, 339, 50, 50);
		getContentPane().add(btnNewButton_31);
