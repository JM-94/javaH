...
public class Main extends JFrame {
	...
	public static String[] menu = { "NBB시그니처세트", "NBB오리지널세트", "NBB어메이징세트", "미트마니아세트", "메가바이트세트", "산체스세트", "스모키살사세트", "데리마요세트",
	...
	public static int[] price = { 5300, 4700, 6500, 6900, 5900, 5700, 5600, 4700, 3900, 5800, 3500, 2900, 4900, 5300, 4300,
	...
	public Main() {
		...
		// 뒤로가기
		JButton backbtn = new JButton("");
		backbtn.setBounds(862, 843, 22, 18);
